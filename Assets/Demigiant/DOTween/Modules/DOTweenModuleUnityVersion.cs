...
namespace DG.Tweening
{
    ...
    public static class DOTweenModuleUnityVersion
    {
        ...
        /// <summary>
        ///     Returns a <see cref="CustomYieldInstruction" /> that waits until the tween is killed or has reached the given
        ///     position (loops included, delays excluded).
        ///     It can be used inside a coroutine as a yield.
        ///     <para>Example usage:</para>
            ...
            int propertyID, float duration)
        {
            ...
            var t = DOTween.To(() => target.GetTextureOffset(propertyID), x => target.SetTextureOffset(propertyID, x),
                endValue, duration);
            t.SetTarget(target);
            return t;
        }
            ...
            int propertyID, float duration)
        {
            ...
            var t = DOTween.To(() => target.GetTextureScale(propertyID), x => target.SetTextureScale(propertyID, x),
                endValue, duration);
            t.SetTarget(target);
            return t;
        }
